/**
 * PatientStep2Personal - CITAMED.VE
 * M01.3 Registro Multi-Paso
 *
 * Paso 2: Datos personales
 * - Nombre y apellido
 * - Cédula (con verificación de disponibilidad)
 * - Fecha de nacimiento
 * - Género
 * - Teléfono
 */
...
/**
 * Componente Paso 2: Datos Personales
 */
function PatientStep2Personal({ formData, updateField, errors, setFieldErrors, onNext, onPrev }) {
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2">
            ...
            {!checkingCedula && cedulaAvailable === false && (
        ...
        <div className="grid grid-cols-2 gap-3">
          {GENDERS.map((gender) => (
            <button
              ...
              className={`
                py-3 px-4 border rounded-lg text-sm font-medium transition-colors
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500">
          Formato: 0412, 0414, 0416, 0424 o 0426 + 7 dígitos
        </p>
      </div>
...
export default PatientStep2Personal;
