/**
 * DoctorStep1Credentials - CITAMED.VE
...
function DoctorStep1Credentials({ formData, updateField, errors, setFieldErrors, onNext }) {
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Crea tu cuenta de médico</h2>
      ...
      <div>
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <span className="text-sm text-gray-600">
            ...
            {' '}y el{' '}
            <a href="/codigo-etica" className="text-primary hover:underline" target="_blank">
      ...
      <div className="bg-teal-50 border border-teal-200 rounded-lg p-4">
        <p className="text-sm text-teal-700">
          ...
          equipo verifique sus credenciales profesionales (MPPS).
        </p>
      </div>
...
export default DoctorStep1Credentials;
