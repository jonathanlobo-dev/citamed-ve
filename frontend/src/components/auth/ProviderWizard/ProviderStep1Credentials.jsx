/**
 * ProviderStep1Credentials - CITAMED.VE
...
function ProviderStep1Credentials({ formData, updateField, errors, setFieldErrors, onNext }) {
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Crea tu cuenta empresarial</h2>
        <p className="text-gray-600 mt-2">Ingresa tus credenciales de acceso</p>
      </div>
          ...
          <input
            ...
            className={`w-full pl-10 pr-10 py-3 border rounded-lg focus:outline-none focus:ring-2
              ${errors.email ? 'border-red-500 focus:ring-red-200'
                : emailAvailable === true ? 'border-green-500 focus:ring-green-200'
                : 'border-gray-300 focus:ring-primary/20 focus:border-primary'}`}
            placeholder="empresa@email.com"
          />
          <div className="absolute right-3 top-1/2 -translate-y-1/2">
            {checkingEmail && <Loader2 className="h-5 w-5 text-gray-400 animate-spin" />}
            {!checkingEmail && emailAvailable === true && <Check className="h-5 w-5 text-green-500" />}
            {!checkingEmail && emailAvailable === false && <X className="h-5 w-5 text-red-500" />}
          </div>
        </div>
        {errors.email && (
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-10 py-3 border rounded-lg focus:outline-none focus:ring-2
              ${errors.password ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-primary/20 focus:border-primary'}`}
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
        <p className="text-sm text-orange-700">
          <strong>Nota:</strong> Su cuenta quedará en estado de revisión hasta que nuestro
          equipo verifique la documentación de su empresa.
        </p>
      </div>

      {/* Next Button */}
      <div className="pt-4">
        <button type="button" onClick={handleNext} disabled={checkingEmail}
...
export default ProviderStep1Credentials;
